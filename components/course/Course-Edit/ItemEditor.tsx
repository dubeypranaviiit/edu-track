...
const ItemEditor = ({ subtopic, onUpdate }: Props) => {
  ...
  const handleAddItem = async () => {
    ...
    try {
      await axios.post(`/api/instructor/create-item/${subtopic._id}`, formData)
  ...
  const handleEditItem = async (itemId: string) => {
    ...
    try {
      await axios.put(`/api/instructor/update-item/${itemId}`, formData)
      setEditItemId(null)
      onUpdate()
    } catch (err) {
      console.error(err)
  ...
  const handleDeleteItem = async (itemId: string) => {
    ...
    try {
      await axios.delete(`/api/instructor/update-item/${itemId}`)
      onUpdate()
    } catch (err) {
      console.error(err)
